...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array())
    {
        ...
        $this->methodMap = array(
            ...
            'admin.competence' => 'getAdmin_CompetenceService',
            'admin.diplome' => 'getAdmin_DiplomeService',
            'admin.experience' => 'getAdmin_ExperienceService',
            'admin.me' => 'getAdmin_MeService',
            'admin.realisation' => 'getAdmin_RealisationService',
            'admin.utilisateur' => 'getAdmin_UtilisateurService',
    ...
    /**
     * Gets the public 'admin.competence' autowired service.
     *
     * @return \AppBundle\Admin\CompetenceAdmin
     */
    protected function getAdmin_CompetenceService()
    {
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Admin/AdminInterface.php';
        include_once $this->targetDirs[3].'/vendor/symfony/security-acl/Model/DomainObjectInterface.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Admin/AbstractAdmin.php';
        include_once $this->targetDirs[3].'/src/AppBundle/Admin/CompetenceAdmin.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Security/Handler/SecurityHandlerInterface.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Security/Handler/NoopSecurityHandler.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Translator/LabelTranslatorStrategyInterface.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Translator/NativeLabelTranslatorStrategy.php';

        $instance = new \AppBundle\Admin\CompetenceAdmin('admin.competence', 'AppBundle\\Entity\\Competence', 'SonataAdminBundle:CRUD');
    ...
    /**
     * Gets the public 'admin.diplome' autowired service.
     *
     * @return \AppBundle\Admin\DiplomeAdmin
     */
    protected function getAdmin_DiplomeService()
    {
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Admin/AdminInterface.php';
        include_once $this->targetDirs[3].'/vendor/symfony/security-acl/Model/DomainObjectInterface.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Admin/AbstractAdmin.php';
        include_once $this->targetDirs[3].'/src/AppBundle/Admin/DiplomeAdmin.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Security/Handler/SecurityHandlerInterface.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Security/Handler/NoopSecurityHandler.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Translator/LabelTranslatorStrategyInterface.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Translator/NativeLabelTranslatorStrategy.php';

        $instance = new \AppBundle\Admin\DiplomeAdmin('admin.diplome', 'AppBundle\\Entity\\Diplome', 'SonataAdminBundle:CRUD');
    ...
    /**
     * Gets the public 'admin.experience' autowired service.
     *
     * @return \AppBundle\Admin\ExperienceAdmin
     */
    protected function getAdmin_ExperienceService()
    {
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Admin/AdminInterface.php';
        include_once $this->targetDirs[3].'/vendor/symfony/security-acl/Model/DomainObjectInterface.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Admin/AbstractAdmin.php';
        include_once $this->targetDirs[3].'/src/AppBundle/Admin/ExperienceAdmin.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Security/Handler/SecurityHandlerInterface.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Security/Handler/NoopSecurityHandler.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Translator/LabelTranslatorStrategyInterface.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Translator/NativeLabelTranslatorStrategy.php';

        $instance = new \AppBundle\Admin\ExperienceAdmin('admin.experience', 'AppBundle\\Entity\\Experience', 'SonataAdminBundle:CRUD');
    ...
    /**
     * Gets the public 'admin.me' autowired service.
     *
     * @return \AppBundle\Admin\MeAdmin
     */
    protected function getAdmin_MeService()
    {
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Admin/AdminInterface.php';
        include_once $this->targetDirs[3].'/vendor/symfony/security-acl/Model/DomainObjectInterface.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Admin/AbstractAdmin.php';
        include_once $this->targetDirs[3].'/src/AppBundle/Admin/MeAdmin.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Security/Handler/SecurityHandlerInterface.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Security/Handler/NoopSecurityHandler.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Translator/LabelTranslatorStrategyInterface.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Translator/NativeLabelTranslatorStrategy.php';

        $instance = new \AppBundle\Admin\MeAdmin('admin.me', 'AppBundle\\Entity\\Me', 'SonataAdminBundle:CRUD');
    ...
    /**
     * Gets the public 'admin.realisation' autowired service.
     *
     * @return \AppBundle\Admin\RealisationAdmin
     */
    protected function getAdmin_RealisationService()
    {
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Admin/AdminInterface.php';
        include_once $this->targetDirs[3].'/vendor/symfony/security-acl/Model/DomainObjectInterface.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Admin/AbstractAdmin.php';
        include_once $this->targetDirs[3].'/src/AppBundle/Admin/RealisationAdmin.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Security/Handler/SecurityHandlerInterface.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Security/Handler/NoopSecurityHandler.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Translator/LabelTranslatorStrategyInterface.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Translator/NativeLabelTranslatorStrategy.php';

        $instance = new \AppBundle\Admin\RealisationAdmin('admin.realisation', 'AppBundle\\Entity\\Realisation', 'SonataAdminBundle:CRUD');
    ...
    /**
     * Gets the public 'admin.utilisateur' autowired service.
     *
     * @return \AppBundle\Admin\UserAdmin
     */
    protected function getAdmin_UtilisateurService()
    {
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Admin/AdminInterface.php';
        include_once $this->targetDirs[3].'/vendor/symfony/security-acl/Model/DomainObjectInterface.php';
        include_once $this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Admin/AbstractAdmin.php';
        ...
        $instance = new \AppBundle\Admin\UserAdmin('admin.utilisateur', 'AppBundle\\Entity\\User', 'SonataAdminBundle:CRUD');
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('BRWT0k+7yl', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('KG+Sg5+8qs', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('J+UJ-OUVGB', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('v8UPFkRFxF', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getSonata_Admin_PoolService()
    {
        ...
        $instance->setTemplates($this->parameters['sonata.admin.configuration.templates']);
        $instance->setAdminServiceIds(array(0 => 'admin.blog', 1 => 'admin.commentaire', 2 => 'admin.utilisateur', 3 => 'admin.competence', 4 => 'admin.experience', 5 => 'admin.diplome', 6 => 'admin.realisation', 7 => 'admin.me'));
        $instance->setAdminGroups(array('default' => array('label' => 'default', 'label_catalogue' => 'SonataAdminBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'on_top' => false, 'keep_open' => false, 'items' => array(0 => array('admin' => 'admin.blog', 'label' => 'Article', 'route' => '', 'route_params' => array(), 'route_absolute' => false), 1 => array('admin' => 'admin.commentaire', 'label' => 'Commentaires', 'route' => '', 'route_params' => array(), 'route_absolute' => false), 2 => array('admin' => 'admin.utilisateur', 'label' => 'Utilisateur', 'route' => '', 'route_params' => array(), 'route_absolute' => false), 3 => array('admin' => 'admin.competence', 'label' => 'competence', 'route' => '', 'route_params' => array(), 'route_absolute' => false), 4 => array('admin' => 'admin.experience', 'label' => 'experience', 'route' => '', 'route_params' => array(), 'route_absolute' => false), 5 => array('admin' => 'admin.diplome', 'label' => 'diplome', 'route' => '', 'route_params' => array(), 'route_absolute' => false), 6 => array('admin' => 'admin.realisation', 'label' => 'realisation', 'route' => '', 'route_params' => array(), 'route_absolute' => false), 7 => array('admin' => 'admin.me', 'label' => 'Personnel', 'route' => '', 'route_params' => array(), 'route_absolute' => false)))));
        $instance->setAdminClasses(array('AppBundle\\Entity\\Blog' => array(0 => 'admin.blog'), 'AppBundle\\Entity\\commentaires' => array(0 => 'admin.commentaire'), 'AppBundle\\Entity\\User' => array(0 => 'admin.utilisateur'), 'AppBundle\\Entity\\Competence' => array(0 => 'admin.competence'), 'AppBundle\\Entity\\Experience' => array(0 => 'admin.experience'), 'AppBundle\\Entity\\Diplome' => array(0 => 'admin.diplome'), 'AppBundle\\Entity\\Realisation' => array(0 => 'admin.realisation'), 'AppBundle\\Entity\\Me' => array(0 => 'admin.me')));
